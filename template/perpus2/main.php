...
<html>
  <head>
    ...
    <title>Free web designer template - by Devma</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="/template/perpus2/css/animate.min.css">
    <link rel="stylesheet" href="/template/perpus2/css/bootstrap.min.css">
    <link rel="stylesheet" href="/template/perpus2/css/style.css">
    <script src="/template/perpus2/js/wow.min.js"></script>
  ...
  <body>
    <div class="header">
      <div class="navbar">
        ...
        <ul class=""  id="navbarid">
          ...
          <li><a id="about-me" class="active" href="#">about me</a></li>
      ...
      <img src="/template/perpus2/img/container.png" alt="">
      <div class="goahead">
        <a href="#">go ahead</a>
      </div>
    </div>
    ...
    <div class="about-me">
      ...
      <div class="about-me-block col-md-12">
        <div class="item col-md-4 wow fadeIn  data-wow-duration="1s" data-wow-delay="1.5s"">
          <img src="/template/perpus2/img/icon1.png" alt="">
        ...
        <div class="item col-md-4 wow fadeIn  data-wow-duration="1s" data-wow-delay="2s"">
          <img src="/template/perpus2/img/icon2.png" alt="">
          <h3>Design afterwards</h3>
          <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren</p>
        </div>
        <div class="item col-md-4 wow fadeIn  data-wow-duration="1s" data-wow-delay="2.5s"">
          <img src="/template/perpus2/img/icon3.png" alt="">
          <h3>Finalize</h3>
          <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren</p>
        </div>
      </div>
    ...
    <div class="work col-md-12">
      <div class="work-item col-md-6 wow fadeIn  data-wow-duration="2s" data-wow-delay="1s"">
        <img src="/template/perpus2/img/work1.png" alt="">
        <div class="more-details">
          <img src="/template/perpus2/img/show.png" alt="">
      ...
      <div class="work-item col-md-6 wow fadeIn  data-wow-duration="2s" data-wow-delay="1.5s"">
        <img src="/template/perpus2/img/work2.png" alt="">
        <div class="more-details">
          <img src="/template/perpus2/img/show.png" alt="">
          <div class="description">
            <h3>Lorem ipsum dolor sit</h3>
      ...
      <div class="work-item col-md-6 wow fadeIn  data-wow-duration="2s" data-wow-delay="1s"">
        <img src="/template/perpus2/img/work3.png" alt="">
        <div class="more-details">
          <img src="/template/perpus2/img/show.png" alt="">
          <div class="description">
            <h3>Lorem ipsum dolor sit</h3>
      ...
      <div class="work-item col-md-6 wow fadeIn  data-wow-duration="2s" data-wow-delay="1.5s"">
        <img src="/template/perpus2/img/work4.png" alt="">
        <div class="more-details">
          <img src="/template/perpus2/img/show.png" alt="">
          <div class="description">
            <h3>Lorem ipsum dolor sit</h3>
...
<div class="goTop"><i class="fa fa-arrow-up" aria-hidden="true"></i></div>
    <script src="/template/perpus2/js/jquery.min.js"></script>
    <script src="/template/perpus2/js/mainscript.js"></script>
  </body>
</html>
